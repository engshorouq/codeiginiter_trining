...
<head>
    ...
    <link href="<?=base_url()?>assets/admin/pages/css/login-rtl.css" rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME STYLES -->
    <link href="<?=base_url()?>assets/global/css/components-rtl.css" id="style_components" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?=base_url()?>assets/admin/layout/css/themes/darkblue-rtl.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
    <a href="index.html">
        <img src="<?=base_url()?>uploads/logo-b.png" width="150" height="150" alt=""/>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
...
<form class="login-form" action="<?=base_url()?>login/check_user" method="post">
    ...
    <div class="form-group">
        ...
        <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="اسم المستخدم" name="username"/>
    </div>
    <div class="form-group">
...
<div class="copyright">
    2014 ©شركة توزيع كهرباء محافظات غزة
</div>
<!-- END LOGIN -->
