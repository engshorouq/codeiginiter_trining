...
<div class="container-fluid">
    ...
    echo form_open('admin/Posts/add_post_paging', $attribute, $hidden);
    ?>
    <fieldset>
        <legend style="width: 1000px;">اضافة منشور</legend>
        <div style="position: relative;z-index: 1;">
            <!-- hidden field for type of post 0 classification and 1 paging  -->
            <input type="hidden" class="form-control" name="type_cat" id="type_cat" value="1">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <textarea class="wysihtml5 form-control" name="body" rows="10" id="textArea"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-lg-6 col-lg-offset-2">
                    ...
                    <a href="<?=base_url()?>admin/Posts/display_pages" class="btn btn-default">الغاء</a>

                </div>
            </div>
        </div>
        <div style="overflow:scroll;height:500px;position: absolute;z-index: 2;left: 50px;top: 80px;border: 1px solid #e5e5e5;width: 300px;padding: 10px;">
