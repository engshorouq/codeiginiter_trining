...
<script src="<?= base_url(); ?>/assets/global/scripts/ajax.js" type="text/javascript"></script>
<script src="<?= base_url(); ?>/assets/global/scripts/jqueryval.min.js" type="text/javascript"></script>
<script src="<?= base_url(); ?>/assets/global/scripts/jquery.nestable-rtl.js" type="text/javascript"></script>
...
<script>
    jQuery(document).ready(function() {
        ...
        Tasks.initDashboardWidget();
            /*for body in banners to add image , fonts ..etc*/
            $('textarea[data-richtext]').summernote({height : 400});
