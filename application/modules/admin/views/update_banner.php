...
<div class="container-fluid">
    ...
    echo form_open('admin/Banners/display_id/'.$id,$attribute,$hidden);

    ?>
    <fieldset>
        <legend style="width: 1000px;"> تعديل البنر</legend>
        ...
        <div style="position: relative;z-index: 1;">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea data-richtext="true" class="form-control"  style="width: 800px; display: none;" name="body" rows="10" id="textArea"  ><?=$row['BODY']?></textarea>
                </div>
            </div>
