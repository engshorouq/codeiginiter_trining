            ...
            <div class="portlet box purple">
                ...
                <div class="portlet-body form">
                    <div class="form-horizontal">
                        ...
                        <input type="hidden" name="type_cat" class="type_cat" id="type_cat" value="1">
...
<form method="post" id="form_delete_all_posts" class="form-horizontal" enctype="multipart/form-data"
      action="<?php echo base_url(); ?>admin/Posts/delete_all">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-horizontal">
                        <div>
                            ...
                            <a href="<?= base_url(); ?>admin/Posts/add_post_paging" class="test_link btn green"
                        ...
                        <table class="table table-hover table-striped table-bordered dataTable"
                            ...
                            foreach ($rows as $row) {
                                ...
                                <tr data-id="<?=$row['ID'];?>">
                                    <td><?= ++$count; ?></td>
                                    <th><input type="checkbox" name="delete[]" value="<?= $row['ID'] ?>"></th>
        ...
        <div class="modal-content" style=" height: 250px !important;overflow:visible;">
            ...
            <div class="modal-body" style="margin: 5px;height: 80%;overflow: auto;">
                <form name="formAdd" id="post_form_delete" method="post" class="form-horizontal"
                      ...
                      action="<?php echo base_url(); ?>admin/Posts/delete_post">
                    <fieldset>
